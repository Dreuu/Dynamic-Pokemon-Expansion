...
const struct PokedexEntry gPokedexEntries[NATIONAL_DEX_COUNT] =
{
	...
	{
		.categoryName = {_S, _t, _i, _k, _e, _r, _END, _SPACE, _SPACE, _SPACE, _SPACE, _SPACE},
		.height = 14,
		.weight = 330,
	...
	[NATIONAL_DEX_ALCREMIE] =
	{
		...
		.height = 3,
		.weight = 5,
		.description = DEX_ENTRY_ALCREMIE,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	{
		.categoryName = {_T, _w, _o, _SPACE, _S, _i, _d, _e, _d, _END, _SPACE, _SPACE},
		.height = 3,
		.weight = 30,
