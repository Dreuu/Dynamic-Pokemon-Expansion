...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_PIKACHU] =          {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU, 0},
								  {EVO_ITEM, ITEM_LINK_STONE, SPECIES_RAICHU_A, 0}},
	...
	[SPECIES_TOXEL] =			 {{EVO_LEVEL, 30, SPECIES_TOXTRICITY, 0}},
	...
	[SPECIES_MILCERY] =			 {{EVO_HOLD_ITEM_DAY, ITEM_BERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY, 0},
								  {EVO_HOLD_ITEM_NIGHT, ITEM_BERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY, 0}},
	...
	[SPECIES_FARFETCHD_G] =		 {{EVO_MOVE, MOVE_SWORDSDANCE, SPECIES_SIRFETCHD, 0}},
	[SPECIES_MR_MIME_G] =		 {{EVO_LEVEL, 42, SPECIES_MR_RIME, 0}},
	[SPECIES_YAMASK_G] =		 {{EVO_MAP, 3, SPECIES_RUNERIGUS, 45},
								  {EVO_LEVEL, 36, SPECIES_RUNERIGUS, 0}},
};
